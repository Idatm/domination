	...
	
	{
		...
		public String getOrientation() // il faut définir une orientation en 2D : 4 possibilités : haut droite bas gauche
						//									          [2,	
						// Chaque domino est divisé en 2 demis dominos : [1,2] donc 4 possibilités:        1]
						//								             [2,1]   [1,2]    d
						//									          [1,
						//									           2]
						// Utilisons des 
